        ...
        for (const def of tools) {
            ...
            if (!def.isPatchingTool) {
                implementation = async (args) => {
                    const module = await import(def.modulePath + '.js');
                    // Fall back to first exported value or namespace object if default export is not defined
                    const rawImpl = module.default !== undefined 
                        ? module.default 
                        : (Object.values(module)[0] !== undefined ? Object.values(module)[0] : module);
                    return await def.adapter(args, rawImpl);
                };
            }
